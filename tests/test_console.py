...
class Test_console_command_help(TestCase):
    """[Unnitest AirBnB_clone: console dedicated to help function]
    """
...
class Test_console_method_all(TestCase):
    """[Unnitest AirBnB_clone console dedicated to all function]
    """
    @classmethod
...
class Test_console_method_count(TestCase):
    """[Unnitest AirBnB_clone console dedicated to count function]
    """
    @classmethod
    def setUpClass(cls) -> None:
        try:
...
class Test_console_method_create(TestCase):
    """[Unnitest AirBnB_clone console dedicated to create function]
    """
    @classmethod
    def setUpClass(cls) -> None:
        try:
...
class Test_console_method_destroy(TestCase):
    """[Unnitest AirBnB_clone console dedicated to destroy function]
    """
    @classmethod
    def setUpClass(cls) -> None:
        try:
...
class Test_console_method_destroy(TestCase):
    """[Unnitest AirBnB_clone console dedicated to show function]
    """
    @classmethod
    def setUpClass(cls) -> None:
        try:
...
class Test_console_method_update(TestCase):
    """[Unnitest AirBnB_clone console dedicated to update function]
    """
    @classmethod
    def setUpClass(cls) -> None:
        try:
